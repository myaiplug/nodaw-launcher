...
$target = "TimeStretchX_VST3"
$vstBundleName = "Time Stretch X.vst3"
$sourceVst3 = Join-Path $buildDir "TimeStretchX_artefacts/$Config/VST3/$vstBundleName"

$distRoot = Join-Path $projectRoot "dist"
$releaseName = "TimeStretchX-v$Version-win64"
...
$vstBinaryRelative = "Contents/x86_64-win/Time Stretch X.vst3"
