...
$target = "ClipIT_VST3"
$vstBundleName = "Clip-IT.vst3"
$sourceVst3 = Join-Path $buildDir "ClipIT_artefacts/$Config/VST3/$vstBundleName"

$distRoot = Join-Path $projectRoot "dist"
$releaseName = "Clip-IT-v$Version-win64"
...
$vstBinaryRelative = "Contents/x86_64-win/Clip-IT.vst3"
