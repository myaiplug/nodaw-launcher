...
export const TOOLS: Tool[] = [
  {
    ...
    description: 'Extract vocals, drums, bass, and more using deep learning',
    icon: '🎵',
    tier: 'pro',
  ...
  },
  {
    ...
    description: 'Slow, chop, and manipulate audio with surgical precision',
    icon: '🔩',
    tier: 'pro',
  ...
  },
  {
    ...
    description: 'Cut, split, and export audio segments with waveform accuracy',
    icon: '✂️',
    tier: 'free',
  ...
  },
  {
    ...
    description: 'Convert between MP3, WAV, FLAC, OGG, and more',
    icon: '🔄',
    tier: 'free',
  ...
  },
  {
    ...
    description: 'Professional effect chains in a single click',
    icon: '✨',
    tier: 'pro',
  ...
  },
  {
    ...
    description: 'Full-featured mixing and rendering workstation',
    icon: '🎛️',
    tier: 'pro_plus',
